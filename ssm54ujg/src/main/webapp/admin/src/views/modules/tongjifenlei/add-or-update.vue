<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="事件描述" prop="shijianmiaoshu">
          <el-input v-model="ruleForm.shijianmiaoshu" 
              placeholder="事件描述" clearable  :readonly="ro.shijianmiaoshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="事件描述" prop="shijianmiaoshu">
              <el-input v-model="ruleForm.shijianmiaoshu" 
                placeholder="事件描述" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="事件地址" prop="shijiandizhi">
          <el-input v-model="ruleForm.shijiandizhi" 
              placeholder="事件地址" clearable  :readonly="ro.shijiandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="事件地址" prop="shijiandizhi">
              <el-input v-model="ruleForm.shijiandizhi" 
                placeholder="事件地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="消防隐患分类" prop="xiaofangyinhuanfenlei">
          <el-select v-model="ruleForm.xiaofangyinhuanfenlei" placeholder="请选择消防隐患分类">
            <el-option
                v-for="(item,index) in xiaofangyinhuanfenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="消防隐患分类" prop="xiaofangyinhuanfenlei">
	      <el-input v-model="ruleForm.xiaofangyinhuanfenlei"
                placeholder="消防隐患分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tongjifenlei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tongjifenleiCrossAddOrUpdateFlag = false;
                  this.parent.search();
