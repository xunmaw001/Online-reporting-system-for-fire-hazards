          ...
          <el-form-item class="input" label="联系方式" prop="lianxifangshi">
              <el-input v-model="ruleForm.lianxifangshi" 
                placeholder="联系方式" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="事件时间" prop="shijianshijian">
          <el-input v-model="ruleForm.shijianshijian" 
              placeholder="事件时间" clearable  :readonly="ro.shijianshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="事件时间" prop="shijianshijian">
              <el-input v-model="ruleForm.shijianshijian" 
                placeholder="事件时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.chulizhuangtai"
                placeholder="处理状态" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="处理详情" prop="chulixiangqing">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chulixiangqing" label="处理详情" prop="chulixiangqing">
                    <span>{{ruleForm.chulixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chulijieguo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chulijieguoCrossAddOrUpdateFlag = false;
                  this.parent.search();
